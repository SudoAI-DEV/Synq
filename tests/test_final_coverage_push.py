...
def test_migration_namer_generate_multi_table_name_variations():
    ...
    operations = [
        ...
        MigrationOperation(operation_type=OperationType.ADD_COLUMN, table_name="users", object_name="email")
    ]
...
def test_migration_namer_generate_multi_table_name_add_columns():
    ...
    operations = [
        MigrationOperation(operation_type=OperationType.ADD_COLUMN, table_name="users", object_name="email"),
        MigrationOperation(operation_type=OperationType.ADD_COLUMN, table_name="posts", object_name="title"),
        MigrationOperation(operation_type=OperationType.ADD_COLUMN, table_name="comments", object_name="body"),
        MigrationOperation(operation_type=OperationType.CREATE_TABLE, table_name="temp")
    ]
...
def test_migration_namer_generate_multi_table_name_remove_columns():
    ...
    operations = [
        MigrationOperation(operation_type=OperationType.DROP_COLUMN, table_name="users", object_name="old1"),
        MigrationOperation(operation_type=OperationType.DROP_COLUMN, table_name="posts", object_name="old2"),
        MigrationOperation(operation_type=OperationType.DROP_COLUMN, table_name="comments", object_name="old3"),
        MigrationOperation(operation_type=OperationType.CREATE_TABLE, table_name="temp")
    ]
